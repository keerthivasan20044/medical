...
const HEALTH_RESOURCES = [
  { id: 1, category: 'First Aid', title: 'Handling Heatstroke in Karaikal Coastal Areas', readTime: '5 min', icon: Thermometer, color: 'text-[#028090] bg-[#028090]/10' },
  { id: 2, category: 'Chronic Care', title: 'Managing Diabetes: Local Diet Guide', readTime: '8 min', icon: Pill, color: 'text-[#02C39A] bg-[#02C39A]/10' },
  { id: 3, category: 'Wellness', title: 'Mental Health in Coastal Regions: Complete Guide', readTime: '6 min', icon: Heart, color: 'text-amber-500 bg-amber-50' },
  { id: 4, category: 'Pandemic Safety', title: 'Vaccination Portals Guide 2026', readTime: '4 min', icon: Shield, color: 'text-indigo-500 bg-indigo-50' }
];

const EMERGENCY_CONTACTS = [
  { label: 'General Hospital (KKL)', phone: '04368-222222', status: '24/7 Available' },
  { label: 'Ambulance Services', phone: '108', status: 'Priority Line' },
  { label: 'Fire & Rescue', phone: '101', status: 'Emergency Link' },
  { label: 'District Health Hub', phone: '04368-222643', status: 'Inquiry Center' }
];
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center">
               <div className="lg:col-span-8 space-y-10">
                  <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-[#0a1628] border border-white/10 rounded-full backdrop-blur-md shadow-2xl">
                     ...
                     <span className="text-[10px] font-black uppercase tracking-widest text-white font-syne italic">Health Resources</span>
                  </div>
                  <h1 className="font-syne font-black text-6xl md:text-8xl text-[#0a1628] leading-[1.05] tracking-tighter">
                     Verified <br />
                     <span className="text-[#028090]">Health Resources.</span>
                  </h1>
                  <p className="font-dm text-xl text-gray-400 max-w-2xl italic leading-relaxed">Connecting you with verified health resources to empower every household in Karaikal with real-time medical advice and verified health archives.</p>
                  
                  <div className="flex flex-wrap gap-4 pt-4">
                     {['District Updates', 'Regional Archives', 'Secure Platform'].map(tag => (
                ...
                <div className="lg:col-span-4 hidden lg:block">
                  <div className="bg-[#0a1628] rounded-[3.5rem] p-10 space-y-8 shadow-4xl relative overflow-hidden group">
                     ...
                     <h3 className="font-syne font-black text-2xl text-white leading-tight">Need Medical <br /> Guidance?</h3>
                     <p className="text-white/40 font-dm text-sm leading-relaxed italic">Our health support AI is available 24/7 for resource navigation and emergency help.</p>
                     <button className="w-full py-5 bg-[#02C39A] text-[#0a1628] rounded-2xl font-syne font-black text-xs uppercase tracking-widest shadow-2xl shadow-black/20 hover:scale-[1.02] active:scale-95 transition-all">Start Chat</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            >
               ...
               <div className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-2">
                     <div className="text-[10px] text-[#02C39A] font-black uppercase tracking-widest leading-none underline underline-offset-4 decoration-[#02C39A]/30">Safety Guide</div>
         ...
         <div className="bg-[#0a1628] rounded-[5rem] p-16 md:p-32 flex flex-col lg:flex-row items-center justify-between gap-20 relative overflow-hidden group shadow-4xl shadow-[#0a1628]/20">
            ...
            <div className="space-y-12 max-w-2xl relative z-10 text-center lg:text-left">
               <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/5 border border-white/10 rounded-full text-[#02C39A] font-black text-[10px] uppercase tracking-widest backdrop-blur-md">
                  <MapPin size={16} /> Karaikal Health Network Active
               </div>
               <h2 className="font-syne font-black text-5xl md:text-7xl text-white leading-[1.05] tracking-tighter">
                  Every District <br />
                  <span className="text-[#02C39A]">Healthcare Facility.</span>
               </h2>
               <p className="font-dm text-lg text-white/40 italic leading-relaxed">From Government portals to private clinics, we connect you with every verified healthcare facility in Karaikal to ensure you have the information you need in critical moments.</p>
               <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                  {['Pharmacy Network', 'Lab Services', 'Blood Bank', 'Medical Support'].map(tag => (
            ...
            <div className="relative z-10 flex flex-col items-center shrink-0">
               ...
               <div className="text-[10px] font-black text-[#02C39A] uppercase tracking-[0.5em] mb-16 italic">Platform Active</div>
               <button className="px-16 py-7 bg-white text-[#0a1628] rounded-[2.5rem] font-syne font-black text-sm uppercase tracking-widest shadow-4xl hover:bg-[#02C39A] hover:rotate-1 active:scale-95 transition-all">Share Resource &rarr;</button>
            </div>
         </div>
      </section>
    </div>
