         ...
         {!debouncedQuery ? (
            ...
            <div className="space-y-32">
               ...
               {(activeTab === 'All' || activeTab === 'Pharmacies') && results.pharmacies.length > 0 && (
                  <section className="space-y-12">
                     <div className="flex items-center justify-between border-b border-gray-50 pb-8">
                        <h2 className="font-syne font-black text-3xl text-[#0a1628] flex items-center gap-6"><Store className="text-[#02C39A]" size={36}/> {t('pharmaciesResults')}</h2>
                     </div>
                        ...
                        {results.pharmacies.map(p => (
                           <Link to={`/pharmacies/${p.id}`} key={p.id} className="p-8 md:p-10 bg-[#0a1628] rounded-[3rem] md:rounded-[3.5rem] text-white space-y-8 group hover:-translate-y-2 transition duration-500 shadow-3xl shadow-[#0a1628]/20 relative overflow-hidden">
                              ...
                              <div className="flex items-center justify-between pt-4 border-t border-white/5 relative z-10">
                                 <div className="text-[10px] font-black uppercase tracking-widest text-[#02C39A]">{t('open247')}</div>
               ...
               {(activeTab === 'All' || activeTab === 'Doctors') && results.doctors.length > 0 && (
                  <section className="space-y-12">
                     <div className="flex items-center justify-between border-b border-gray-50 pb-8">
                        <h2 className="font-syne font-black text-3xl text-[#0a1628] flex items-center gap-6"><User className="text-[#028090]" size={36}/> {t('doctorsResults')}</h2>
                     </div>
                     <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
               ...
               {(activeTab === 'All' || activeTab === 'Blog') && results.blog.length > 0 && (
                  <section className="space-y-12">
                     <div className="flex items-center justify-between border-b border-gray-50 pb-8">
                        <h2 className="font-syne font-black text-3xl text-[#0a1628] flex items-center gap-6"><BookOpen className="text-[#02C39A]" size={36}/> {t('healthArticles')}</h2>
                     </div>
