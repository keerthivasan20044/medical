...
export default function DeliveryTraining() {
  ...
  const courses = [
    { id: 'safety', title: 'Road Safety Protocol', desc: 'Karaikal traffic guidelines and emergency safety.', duration: '15 min', status: 'Completed', icon: Shield, color: 'text-emerald-500 bg-emerald-50' },
    ...
    { id: 'app', title: 'Interface Mastery', desc: 'Complete guide to the MediReach Agent app.', duration: '12 min', status: 'Pending', icon: Play, color: 'text-purple-500 bg-purple-50' },
  ];
  ...
  return (
    <div className="space-y-10 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="font-syne font-black text-4xl text-navy italic tracking-tighter uppercase">Agent Training</h1>
          <p className="text-xs font-dm font-bold text-navy/40 uppercase tracking-widest mt-1 italic">Certification & Skill Enhancement</p>
        </div>
        ...
        {courses.map((c) => (
          <div key={c.id} className="bg-white p-10 rounded-[3.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all group relative overflow-hidden">
             ...
             <div className="mt-8 flex items-center gap-6">
                ...
                <button 
                  onClick={() => toast.success('Launching Training Module...')}
      ...
      <div className="bg-navy rounded-[4rem] p-12 text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10">
         ...
         <div className="space-y-3 relative z-10 text-center md:text-left">
            <h2 className="font-syne font-black text-3xl uppercase italic tracking-tighter leading-none">Global ID Card</h2>
            <p className="text-white/40 font-dm text-sm italic uppercase tracking-widest">Download your verified agent identification.</p>
         </div>
