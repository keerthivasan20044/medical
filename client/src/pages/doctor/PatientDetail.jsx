...
export default function PatientDetail() {
  return (
    <PageShell 
      ...
      subtitle="Medical history for patient: Ramesh Kumar."
      icon={User}
      actions={
        <div className="flex gap-4">
          <button className="h-16 px-10 bg-brand-teal text-[#0a1628] font-syne font-black text-xs rounded-2xl flex items-center gap-3 active:scale-95 shadow-4xl italic uppercase tracking-wider group">
            <Plus size={18} className="group-hover:animate-pulse" /> Create Prescription
          </button>
      ...
      <div className="p-20 grid lg:grid-cols-[1fr_450px] gap-20">
         <div className="space-y-16">
            ...
            <div className="space-y-8">
               ...
               <div className="space-y-6">
                  {[
                     { date: '24 Mar 2026', type: 'Clinical Consultation', item: 'KKL-GENERAL-HOST', clinical: 'Viral Fever Cluster' },
                     { date: '12 Feb 2026', type: 'Lab Test', item: 'KKL-DIAGNOSTIC-NODE', clinical: 'Blood Audit Complete' }
                  ].map(log => (
                     <div key={log.date} className="bg-white p-10 rounded-[3.5rem] border border-black/[0.03] shadow-soft hover:shadow-4xl transition-all duration-700 flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center gap-8">
                           ...
                           <div className="space-y-1">
                              <div className="text-[10px] text-gray-300 font-black uppercase tracking-widest italic">{log.date} — {log.item}</div>
         ...
         <div className="space-y-12">
               ...
               <div className="space-y-8 relative z-10">
                  <div className="flex items-center gap-6">
                     ...
                     <div>
                        ...
                        <p className="text-white/40 font-dm italic font-bold">Last Updated: Today 10:42 AM</p>
                     </div>
                  </div>
                  ...
                  <div className="space-y-6">
                     <div className="p-8 bg-white/5 border border-white/5 rounded-3xl flex items-center justify-between group hover:bg-white/10 transition">
                        <div className="space-y-1">
                           <div className="text-[10px] text-brand-teal font-black uppercase tracking-widest italic leading-none">Blood Pressure</div>
            ...
            <div className="bg-white p-12 rounded-[4rem] border border-black/[0.03] shadow-inner space-y-6 group">
               ...
               <p className="text-[#0a1628]/60 font-dm italic font-bold">This patient record is private and secure.</p>
            </div>
         </div>
      </div>
    </PageShell>
