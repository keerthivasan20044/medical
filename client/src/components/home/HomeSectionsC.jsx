...
export function VaccineShowcase() {
   ...
   return (
      <section className="py-16 md:py-32 bg-[#028090]/5 relative overflow-hidden">
         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-teal-400/5 rounded-full blur-[150px]" />
         <div className="max-w-7xl mx-auto px-4 md:px-10 relative z-10">
            <div className="flex items-center justify-between mb-12 md:mb-20 border-l-8 border-teal-400 pl-6 md:pl-10">
               <h2 className="font-syne font-black text-[navy] text-4xl md:text-6xl leading-[0.9] uppercase italic tracking-tighter">
                  {t('vaccinesAvailable')}
               </h2>
               ...
               {loading ? (
                 ...
                 vaccines.map((v, i) => (
                   <motion.div 
                      ...
                      className={`group bg-white rounded-[3.5rem] border-4 border-white shadow-3xl overflow-hidden flex flex-col h-full transition-all duration-700 hover:shadow-4xl hover:border-teal-400/20 ${v.stockCount > 0 ? '' : 'opacity-40 grayscale pointer-events-none'}`}
                   >
                      <div className="h-64 overflow-hidden shrink-0 relative shadow-inner">
                         ...
                         <div className={`absolute bottom-6 left-6 text-[9px] font-black px-5 py-2.5 rounded-xl shadow-4xl uppercase italic tracking-[0.2em] border ${v.stockCount > 0 ? 'bg-teal-400 text-[navy] border-teal-400/20' : 'bg-gray-400 text-white border-transparent'}`}>
                            {v.stockCount > 0 ? `✓ ${t('available')}` : `✗ ${t('outOfStock')}`}
                         </div>
                      </div>
                     <div className="p-10 flex-1 flex flex-col justify-between space-y-6 relative">
                         <div className="space-y-3">
                            <h3 className="font-syne font-black text-[navy] text-xl uppercase italic tracking-tighter truncate">{v.name}</h3>
                            <div className="text-[10px] font-black text-teal-400 uppercase tracking-[0.3em] italic">Dose: {v.generic || 'Standard'}</div>
                         </div>
                         <div className="pt-8 border-t-2 border-dashed border-black/[0.05] flex items-center justify-between gap-6">
                            <div className="grow">
                               ...
                               <div className="text-xs font-black text-[navy] uppercase italic truncate tracking-tight">{v.brand || 'Central'}</div>
                            </div>
                            <div className="text-right shrink-0">
                               <div className="text-[9px] text-gray-300 uppercase tracking-widest font-black italic mb-1">{t('priceCard')}</div>
                               <div className="text-xs font-black text-teal-400 leading-none italic">₹{v.price}</div>
                            </div>
                         </div>
                      </div>
                   </motion.div>
...
export function HowItWorks() {
   ...
   return (
      <section className="py-16 lg:py-40 bg-[navy] relative overflow-hidden">
         {/* Network Overlay */}
         ...
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[600px] bg-teal-400/5 rounded-full blur-[250px] opacity-20" />
         
         <div className="max-w-7xl mx-auto px-4 md:px-10 relative z-10">
            <div className="text-center space-y-8 mb-16 md:mb-32">
               <div className="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 rounded-full text-teal-400 font-syne font-black text-[10px] uppercase tracking-[0.4em] italic shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12 relative">
               ...
               <div className="hidden lg:block absolute top-[3.5rem] left-[15%] right-[15%] h-[2px] bg-gradient-to-r from-transparent via-teal-400/20 to-transparent z-0" />
               ...
               {STEPS.map((s, i) => (
                  ...
                  >
                     <div className="relative mx-auto h-28 w-28 bg-white/5 border-2 border-white/10 rounded-[3rem] flex items-center justify-center text-teal-400 group-hover:bg-teal-400 group-hover:text-[navy] group-hover:rotate-12 group-hover:scale-110 transition-all duration-700 shadow-4xl group-hover:shadow-teal-400/20 backdrop-blur-3xl">
                        <s.icon size={44} className="transition-transform duration-500 group-hover:rotate-[-12deg]" />
                        <div className="absolute -top-4 -right-4 h-12 w-12 bg-[navy] text-teal-400 text-sm font-syne font-black rounded-2xl flex items-center justify-center border-4 border-white/10 group-hover:bg-teal-400 group-hover:text-[navy] transition-all duration-700 shadow-3xl">
                           {s.id}
                        </div>
                     </div>
                     <div className="space-y-4">
                        <h3 className="font-syne font-black text-white text-2xl uppercase italic tracking-tighter group-hover:text-teal-400 transition-colors">{s.title}</h3>
                        <div className="h-1 w-12 bg-teal-400/20 rounded-full mx-auto group-hover:w-full transition-all duration-700" />
   ...
   return (
      <section className="py-16 md:py-32 bg-[#f8fafc] relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4 md:px-10">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 mb-16 md:mb-24 border-l-8 border-teal-400 pl-6 md:pl-10">
               <div className="space-y-6 text-center lg:text-left grow">
                  <h2 className="font-syne font-black text-[navy] text-4xl md:text-7xl leading-[0.9] uppercase italic tracking-tighter">{t('consultOnline')}</h2>
                  <p className="text-gray-400 font-dm text-lg md:text-2xl max-w-3xl italic font-bold leading-relaxed">{t('speakWithDoctors')}</p>
               </div>
               <Link to="/doctors" className="px-10 py-5 md:px-12 md:py-6 bg-[navy] text-teal-400 font-syne font-black text-lg md:text-xl uppercase italic tracking-widest rounded-[1.5rem] md:rounded-[2rem] shadow-4xl hover:bg-teal-400 hover:text-[navy] transition-all duration-700 flex items-center justify-center gap-4 group mx-auto lg:mx-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
               {DOCS.map((doc, i) => (
                  <motion.div 
                     ...
                     whileInView={{ opacity: 1, scale: 1 }}
                     transition={{ delay: i * 0.1, duration: 0.8 }}
                     className="bg-white rounded-[4rem] p-10 border-2 border-black/[0.03] shadow-3xl hover:shadow-4xl hover:border-teal-400/20 transition-all duration-700 group relative overflow-hidden"
                  >
                     ...
                     <div className="flex flex-col items-center text-center space-y-6 pt-6 relative z-10">
                        <div className="relative">
                           <div className="absolute inset-[-8px] border-2 border-teal-400/20 rounded-[2.5rem] animate-spin-slow opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                        ...
                        <div className="space-y-2">
                           <h3 className="font-syne font-black text-[navy] text-2xl uppercase italic tracking-tighter group-hover:text-teal-400 transition-colors truncate w-full">{doc.name}</h3>
                           <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-teal-400/10 rounded-xl text-teal-400 font-syne font-black text-[10px] uppercase tracking-[0.2em] italic">{doc.spec}</div>
                           ...
                           <div className="flex flex-col">
                              ...
                              <span className="text-lg font-syne font-black text-[navy] italic">₹{doc.fee}</span>
                           </div>
                           <div className="flex flex-col">
         ...
         <div className="max-w-7xl mx-auto px-4 md:px-10 grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            <div className="space-y-12 text-center lg:text-left">
               <div className="space-y-6 md:space-y-8">
                  <div className="h-14 w-14 md:h-20 md:w-20 bg-teal-500/10 rounded-2xl md:rounded-3xl flex items-center justify-center text-teal-600 shadow-inner mx-auto lg:mx-0">
                     <Activity size={28} className="md:w-11 md:h-11 animate-pulse" />
                  </div>
                  <h2 className="font-syne font-black text-navy text-3xl md:text-8xl leading-[0.9] uppercase italic tracking-tighter">{t('gpsTrackingTitle')}</h2>
                  <p className="text-gray-400 font-dm text-base md:text-2xl italic font-bold leading-relaxed">{t('gpsTrackingDesc')}</p>
               </div>
               ...
               <div className="space-y-6 md:space-y-8">
                  {[
                     ...
                     <div key={i} className="flex gap-6 md:gap-8 group text-left max-w-md mx-auto lg:mx-0">
                        <div className="h-8 w-8 md:h-10 md:w-10 border-2 border-teal-500/20 rounded-xl md:rounded-2xl flex items-center justify-center text-teal-600 shrink-0 mt-1 duration-700 group-hover:bg-navy group-hover:text-teal-400 group-hover:rotate-12 group-hover:scale-110 shadow-inner"><CheckCircle size={16} strokeWidth={3} /></div>
                        <div className="space-y-0.5">
                           <div className="font-syne font-black text-navy uppercase tracking-[0.05em] md:tracking-[0.1em] italic text-base md:text-lg group-hover:text-teal-600 transition-colors">{f.label}</div>
                           <p className="text-gray-400 font-dm text-xs md:text-sm italic font-bold">{f.desc}</p>
                        </div>
                     </div>
                  ))}
               </div>
            ...
            <div className="relative w-full">
               ...
               <div className="relative bg-[navy] border-4 md:border-8 border-white shadow-4xl rounded-[2.5rem] md:rounded-[5rem] p-6 md:p-16 h-[380px] md:h-[700px] overflow-hidden group">
                  {/* HUD Grid Layout */}
                  ...
                  <motion.div 
                     ...
                     className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] bg-teal-400/5 rounded-full border-2 border-teal-400/20"
                  />
                  ...
                  <motion.div 
                     ...
                     className="absolute left-[70px] bottom-[70px] h-20 w-20 bg-teal-400 rounded-[2rem] shadow-[0_0_40px_rgba(2,195,154,0.4)] flex items-center justify-center text-[navy] border-8 border-white z-20 hover:scale-125 transition-transform"
                  >
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-navy p-6 md:p-12 rounded-3xl md:rounded-[4rem] border-2 border-white/10 shadow-2xl text-center space-y-3 md:space-y-4 w-[220px] md:w-80 transform group-hover:scale-105 md:group-hover:scale-110 transition duration-1000 z-30 backdrop-blur-3xl">
                     ...
                     <div className="text-[7px] md:text-[10px] font-black text-emerald-400 uppercase tracking-widest border-2 border-emerald-500/20 rounded-full py-1.5 md:py-2 px-4 md:px-6 inline-block italic shadow-inner bg-emerald-500/5 animate-pulse">Rider Assigned</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section className="py-16 md:py-32 bg-gradient-to-br from-[#028090] via-[#02C39A] to-[#01606e] relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-4 md:px-10 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
            ...
            >
               ...
               <div className="h-24 w-24 md:h-32 md:w-32 bg-white rounded-[3rem] mx-auto flex items-center justify-center text-teal-400 shadow-4xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-700 relative overflow-hidden">
      ...
      <section className="py-16 md:py-32 bg-white relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4 md:px-10 relative z-10">
            <div className="text-center space-y-8 mb-16 md:mb-24 max-w-4xl mx-auto">
               <div className="inline-flex items-center gap-3 px-6 py-2 bg-[navy] text-teal-400 rounded-full font-syne font-black text-[10px] uppercase tracking-[0.4em] italic shadow-2xl">
                  {t('districtTrusted')}
               </div>
               <h2 className="font-syne font-black text-[navy] text-4xl md:text-8xl leading-none uppercase italic tracking-tighter">
                  {t('voicesOfKaraikal')}
               </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
               {REVIEWS.map((r, i) => (
                  <motion.div 
                     ...
                     whileInView={{ opacity: 1, scale: 1 }}
                     transition={{ delay: i * 0.1, duration: 0.8 }}
                     className="bg-white border-2 border-black/[0.03] p-12 rounded-[4rem] shadow-3xl hover:shadow-4xl hover:border-teal-400/20 transition-all duration-700 relative flex flex-col justify-between group overflow-hidden"
                  >
                     {/* HUD Decorative Corner */}
                     <div className="absolute top-0 right-0 h-24 w-24 bg-teal-400/5 rounded-bl-[4rem] -translate-y-12 translate-x-12 group-hover:translate-y-0 group-hover:translate-x-0 transition-transform duration-700" />
                     ...
                     <div className="flex items-center gap-6 pt-10 border-t-2 border-dashed border-black/[0.05] mt-auto relative z-10">
                        ...
                        <div>
                           <div className="font-syne font-black text-[navy] text-lg uppercase italic tracking-tighter leading-none mb-1">{r.name}</div>
                           <div className="text-[10px] text-teal-400 font-black uppercase tracking-widest italic">{r.area} | Active ✓</div>
                        </div>
                     </div>
                  </motion.div>
               ))}
       ...
       <div className="max-w-7xl mx-auto px-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 text-center relative z-10">
          {LIST.map((f, i) => (
            <div key={i} className="space-y-6 group">
               <div className="h-20 w-20 bg-white/5 border border-white/10 rounded-[2rem] mx-auto flex items-center justify-center text-teal-400 shadow-2xl group-hover:bg-teal-400 group-hover:text-[navy] group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 backdrop-blur-3xl shadow-teal-400/5">
                  <f.icon size={28} />
               </div>
               <div className="space-y-2 px-4 transition-all duration-500 group-hover:translate-y-[-4px]">
                  <h4 className="font-syne font-black text-white text-[10px] uppercase tracking-[0.2em] italic leading-none truncate group-hover:text-teal-400 transition-colors">{f.title}</h4>
            ...
            {[...Array(2)].map((_, groupIdx) => (
               <div key={groupIdx} className="flex items-center gap-16 min-w-full justify-around shrink-0 px-8">
                  {['Apollo Pharmacy', 'MedPlus', 'Sri Murugan Medical', 'Life Care Medicals', 'Grace Pharmacy', 'Karaikal Central', 'M.K. Medicals', 'Sri Dhanvantri'].map(name => (
                     <div key={name} className="font-syne font-black text-[navy]/10 text-2xl uppercase tracking-[0.2em]">{name}</div>
                  ))}
               </div>
            ))}
         </div>
      ...
      <section className="py-24 bg-gray-50">
         <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16 space-y-4">
               <h2 className="font-syne font-black text-[navy] text-4xl leading-tight">Karaikal Health Hub.</h2>
               ...
               {BLOGS.map((b, i) => (
                  <Link key={i} to={`/blog/${b.id}`} className="group bg-white rounded-[3rem] border border-gray-100 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500">
                     ...
                     <div className="p-8 space-y-4">
                        <h3 className="font-syne font-bold font-black text-[navy] leading-tight line-clamp-2 group-hover:text-[#028090] transition text-xl">{b.title}</h3>
...
export function AppDownload() {
   const { t } = useLanguage();
   return (
      <section className="py-40 bg-gradient-to-br from-[navy] via-[#112240] to-[navy] relative overflow-hidden">
         <div className="absolute top-[-10%] left-[-10%] h-[800px] w-[800px] bg-teal-400/5 rounded-full blur-[250px] opacity-20" />
         ...
         <div className="max-w-7xl mx-auto px-4 md:px-10 grid lg:grid-cols-2 gap-32 items-center relative z-10">
            ...
            <div className="relative">
               <div className="absolute inset-0 bg-teal-400 rounded-full blur-[300px] opacity-10 animate-pulse" />
               
               {/* Phone Mockup Housing */}
               <div className="relative h-[650px] md:h-[750px] w-full max-w-[360px] mx-auto bg-[navy] rounded-[5rem] border-[10px] md:border-[14px] border-[navy] shadow-[0_60px_120px_rgba(0,0,0,0.8)] overflow-hidden scale-90 md:scale-100 transition-transform duration-1000 group-hover:rotate-[-5deg] group-hover:scale-105">
                  <div className="h-full w-full bg-slate-900/50 backdrop-blur-3xl relative">
                     {/* Dynamic HUD Interface */}
                     <div className="absolute top-0 left-0 right-0 h-14 bg-[navy] flex items-center justify-center z-50">
                     ...
                     <div className="pt-20 px-8 space-y-10">
                        <div className="flex items-center justify-between">
                           ...
                           <div className="h-12 w-32 bg-teal-400/10 border border-teal-400/20 rounded-2xl" />
                        </div>
                        ...
                        <div className="absolute bottom-10 left-8 right-8 h-24 bg-teal-400 rounded-[2rem] shadow-4xl flex items-center justify-center text-[navy]">
...
export function DistrictBackdrop() {
   const { t } = useLanguage();
   return (
      <section className="py-24 lg:py-56 relative overflow-hidden bg-[navy]">
